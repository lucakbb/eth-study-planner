...
struct SettingsView: View {
    ...
    let settings = [SettingsEntry(name: "Support", image: "mail.fill", color: UIColor(Color("Color3"))), SettingsEntry(name: "GitHub", image: "chevron.left.forwardslash.chevron.right", color: UIColor(Color("Color3"))), SettingsEntry(name: "Review App", image: "star.fill", color: UIColor.systemYellow), SettingsEntry(name: "Legal Notice", image: "book.closed.fill", color: UIColor.gray), SettingsEntry(name: "Privacy Policy", image: "lock.fill", color: UIColor.gray)]
